...
export default function HomePage() {
  ...
  <div style={{ height: '400px', overflow: 'hidden', position: 'relative' }}>
    <img
      ...
      onClick={() => handleImageClick(images[currentImageIndex].sectionId)} 
  ...
  <div style={{ position: 'absolute', bottom: '10px', left: '50%', transform: 'translateX(-50%)', display: 'flex' }}>
    {images.map((image, index) => (
      ...
      {currentImageIndex === 0 && (
        <div ref={conferenceManagementRef} id="conference-management" style={{ textAlign: 'center', padding: '20px 20px' }}>
      ...
      {currentImageIndex === 2 && (
        <div ref={reviewProcessRef} id="review-process" style={{ textAlign: 'center', padding: '20px 20px' }}>
          <div style={{ padding: '20px' }}>
